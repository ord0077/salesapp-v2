...
<form method="POST" action="{{url('edit-aums1-chart ')}}" class="form-horizontal">
{{csrf_field()}}								
...
<input name="aums_1_key" value="<?php echo $ch->aums_1_key?>"   autofocus="autofocus" class="form-control">
</div>

<div class="col-md-6">
<input name="aums_1_value" value="<?php echo $ch->aums_1_value?>"   autofocus="autofocus" class="form-control">
</div>
...
<div class="col-md-2">
<a href="{{url('aums1-edit')}}" class="btn btn-primary">Go Back</a>
</div>
</div>   
<?php } ?>
