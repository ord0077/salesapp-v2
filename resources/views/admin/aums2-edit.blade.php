...
<form method="post" action="{{url('aums2-edit')}}">
{{csrf_field()}}	
...
<div class="col-md-12"><textarea name="f1" class="form-control">{{$result->f1}}</textarea></div>
</div>
...
<tr>
<td>{{$chart->aums_2_key}}</td>
<td>{{$chart->aums_2_value}}</td>
<td>
<a class="" href="{{url('edit-aums2-chart')}}/{{$chart->id}}">Edit</a>
</td>
</tr>
@endforeach
