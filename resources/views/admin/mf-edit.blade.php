...
<form method="post" action="{{url('mf-edit')}}">
{{csrf_field()}}	
...
<th>Field 2</th>
<td>
<textarea name="f2" class="form-control">{{$result->f1}}</textarea>
</td>
</tr>
<tr>
<th>Field 3</th>
<td>
<textarea name="f3" class="form-control">{{$result->f1}}</textarea>
</td>
</tr>
<tr>
<th>Field 4</th>
<td>
<textarea name="f4" class="form-control">{{$result->f1}}</textarea>
</td>
</tr>
