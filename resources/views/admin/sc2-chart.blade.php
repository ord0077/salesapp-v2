...
<form method="POST" action="{{url('edit-sc2-chart')}}" class="form-horizontal">
{{csrf_field()}}								
...
<?php foreach($charts2 as $ch){ ?>
<div class="row">

<div class="col-md-6">
<input type="hidden" name="id" value="<?php echo $ch->id?>"   autofocus="autofocus" class="form-control">
<input name="aums_1_key" value="<?php echo $ch->sc_1_key?>"   autofocus="autofocus" class="form-control">
</div>

<div class="col-md-6">
<input name="aums_1_value" value="<?php echo $ch->sc_1_value?>"   autofocus="autofocus" class="form-control">
</div>
