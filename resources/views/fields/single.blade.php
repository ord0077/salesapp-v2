...
<table class="table">
  ...
  <h4 class="alert alert-success bank_detail">Common Reporting Standard (CRS) Details</h4>
    ...
    <tr>
      ...
      <td class="hide">
<input type="checkbox" name="crs[]" value="crs_name_account_holder"></td>
    ...
    <tr>
      <td class="hide">
<input type="checkbox" name="crs[]" value="crs_family_name"></td>
    ...
    <tr>
      <td class="hide">
<input type="checkbox" name="crs[]" value="crs_given_name"></td>
    ...
    <tr>
      <td class="hide">
<input type="checkbox" name="crs[]" value="crs_middle_name"></td>
    ...
    <tr>
            <td class="hide">
<input type="checkbox" name="crs[]" value="crs_current_address"></td>
    ...
    <tr>
            <td class="hide">
<input type="checkbox" name="crs[]" value="crs_country_txt"></td>
    ...
    <tr>
      <td class="hide">
<input type="checkbox" name="crs[]" value="crs_city_txt"></td>
...
<td class="td_print">{{$crs_details->crs_city_txt}}</td>
    ...
    <tr>
            <td class="hide">
<input type="checkbox" name="crs[]" value="crs_zipcode"></td>
    ...
    <tr>
            <td class="hide">
<input type="checkbox" name="crs[]" value="crs_pobox"></td>
    ...
    <tr>
      ...
      <tr>
        <td class="hide">
<input type="checkbox" name="crs[]" value="mailing_address"></td>
        ...
        <tr>
          ...
          <tr>
            <td class="hide">
<input type="checkbox" name="crs[]" value="mailing_country"></td>
          <th>Country </th>
          ...
          <tr>
            <td class="hide">
<input type="checkbox" name="crs[]" value="mailing_zipcode"></td>
          <th>Postal Code / Zip Code </th>
          ...
          <tr>
            <td class="hide">
<input type="checkbox" name="crs[]" value="mailing_pobox"></td>
          <th>PO Box </th>
          ...
          <tr>
            <td class="hide">
<input type="checkbox" name="crs[]" value="mailing_dob"></td>
          <th>Date of Birth </th>
          ...
          <tr>
            <td class="hide">
<input type="checkbox" name="crs[]" value="mailing_pob"></td>
          ...
          <tr>
            <td class="hide">
<input type="checkbox" name="crs[]" value="mailing_tob"></td>
          <th>Town or City of Birth </th>
          <td class="td_print">{{$crs_details->mailing_tob}}</td>
          </tr>
          <tr>
            <td class="hide">
<input type="checkbox" name="crs[]" value="mailing_cob"></td>
          ...
          <tr>
            <td class="hide">
<input type="checkbox" name="crs[]" value="mailing_tax_country"></td>
          ...
          <tr>
            <td class="hide">
<input type="checkbox" name="crs[]" value="isTaxPayer"></td>
          ...
          <tr>
            <td class="hide">
<input type="checkbox" name="crs[]" value="TaxPayerNumber"></td>
          ...
          <tr>
            <td class="hide">
<input type="checkbox" name="crs[]" value="reason"></td>
          <th>Reason</th>
          ...
          <tr>
            <td class="hide">
<input type="checkbox" name="crs[]" value="specify_second_reason"></td>
