...
<div class="col-lg-12 cash-fund ">
					...
					<p data-animate="fadeInRight">To provide competitive returns to its investors through active investments in low risk portfolio of short duration, while maintaining high liquidity. The Fund aims to maximize returns through efficient utilization of investment and liquidity management tools.</p>
					<h6 data-animate="fadeInRight">Risk Category</h6>
					<img data-animate="fadeInRight" src="./images/cash-fund-color-img.jpg" alt="">
					<h6 data-animate="fadeInRight">Investment Horizon</h6>
					<button data-animate="fadeInRight">Short Term</button>
					</div>
