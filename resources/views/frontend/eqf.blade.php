...
@endforeach
	...
	<div class="col-lg-12 cash-fund ">
					...
					<p data-animate="fadeInRight">The fund objective is to provide its investors maximum risk adjusted returns over longer investment horizon by investing in a diversified equity portfolio that offers both capital gains and dividend income.</p>
					<h6 data-animate="fadeInRight">Risk Category</h6>
					<img data-animate="fadeInRight" src="./images/cash-fund-color-img5.jpg" alt="">
