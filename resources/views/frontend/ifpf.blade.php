...
<h3 class="main-heading" data-animate="fadeInRight">{{$fd->title}}</h3>
	...
	<div class="col-lg-12 cash-fund info">
					...
					<p data-animate="fadeInRight">To generate returns on Investment as per the respective Allocation Plan by investing in Shariah Compliant Mutual Funds in line with the risk tolerance of the Investor.</p>
