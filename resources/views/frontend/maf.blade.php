...
<div class="col-lg-12 cash-fund ">
					...
					<p data-animate="fadeInRight">The objective of the Fund is to provide long-term capital growth and income by investing in multiple asset classes such as equity, equity-related instruments, fixed-income securities, continuous funding system, derivatives, money market instruments, etc.</p>
					<h6 data-animate="fadeInRight">Risk Category</h6>
					<img data-animate="fadeInRight" src="./images/cash-fund-color-img4.jpg" alt="">
					<h6 data-animate="fadeInRight">Investment Horizon</h6>
					<button data-animate="fadeInRight">Long Term</button>
					</div>
