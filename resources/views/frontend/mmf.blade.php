...
<div class="col-lg-12 mmf ">
					<h5 data-animate="fadeInUp">Investment Objective</h5>
					<p data-animate="fadeInRight">The objective of the Fund is to seek high liquidity and comparative return for investors by investing in low risk securities of shorter duration and maturity.</p>
