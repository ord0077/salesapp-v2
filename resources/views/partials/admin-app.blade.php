            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						...
						<li>
							<a href="funds" class="chart-nav"><i class="fa fa-bar-chart nav_icon"></i>Funds <span class="nav-badge-btm pull-right">new</span></a>
						</li>
						
						<li>
							<a href="profiles"><i class="fa fa-user nav_icon"></i>Profiles</a>
						</li>
						
						<li>
							<a href="sales"><i class="fa fa-table nav_icon"></i>Sales <span class="nav-badge">05</span></a>
						</li>
						
						
						<li class="">
							<a href="users"><i class="fa fa-th-large nav_icon"></i>Users</a>
							
							<!-- /nav-second-level -->
						</li>
						<li>
							<a href="settings"><i class="fa fa-cogs nav_icon"></i>Settings</a>
						...
						<li class="dropdown profile_details_drop">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								<div class="profile_img">	
									<span class="prfil-img"><img style="display:none;" src="images/a.png" alt=""> </span> 
									<div class="user-name">
										<p>  {{ Auth::user()->name }}</p>
							...
							<ul class="dropdown-menu drp-mnu">
								<li> <a href="seetings"><i class="fa fa-cog"></i> Settings</a> </li> 
