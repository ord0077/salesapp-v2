...
<td>
<input type="text"class="form-control" name="country1[]" value="{{explode('|',$customer_details->country1)[1]}}">
...
<th>Mailing City</th>
<td>
<input type="text"class="form-control" name="city1[]" value="{{explode('|',$customer_details->city1)[1]}}">
